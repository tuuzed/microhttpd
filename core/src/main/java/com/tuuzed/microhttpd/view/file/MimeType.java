...
import com.tuuzed.microhttpd.common.io.TextFileReader;
...
public class MimeType {
    private Map<String, String> mMimeType = new HashMap<>();
    ...
    public String get(String filename) {
        ...
        if (lastIndexOf > -1) {
            String type = mMimeType.get(filename.substring(lastIndexOf));
            if (type != null) {
                return type;
            }
        }
